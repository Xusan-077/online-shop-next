export default function Footer() {
  return (
    <footer className="footer text-gray-300 py-8 mt-16">
      <div className="footer__container container mx-auto px-6">
        <ul>
          <div className="flex justify-between pb-12.5 border-b border-b-gray-300">
            <div className="flex flex-col">
              <h3 className="text-[14px] font-semibold mb-4 text-black">
                Biz haqimizda
              </h3>
              <ul>
                <li className="text-[12px] text-gray-600 mb-5">
                  Biz bilan bogʻlanish
                </li>
                <li className="text-[12px] text-gray-600 mb-5">Savol-Javob</li>
              </ul>
            </div>
            <div className="flex flex-col">
              <h3 className="text-[14px] font-semibold mb-4 text-black">
              ...
              <ul>
                ...
                <li className="text-[12px] text-gray-600 mb-5">Vakansiyalar</li>
              </ul>
            </div>
            <div className="flex flex-col">
              <h3 className="text-[14px] font-semibold mb-4 text-black">
            ...
            <div className="flex flex-col w-55">
              <span className="text-[14px] block text-black font-semibold">
                Ilovani yuklab olish
              </span>
              <div className="my-3.75 flex justify-between">
                <div className="flex gap-1.25 items-center">
                  <i className="text-[25px] text-black bi bi-apple"></i>
                  <b className="text-black text-3 font-300">AppStore</b>
                </div>
                <div className="flex gap-1.25 items-center">
                  <svg
                    data-v-326dbf2b=""
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#FFBD00"></stop>
                        <stop offset="1" stopColor="#FFE000"></stop>
                      </linearGradient>
                      <linearGradient
                        id="paint1_linear"
                        x1="14.0156"
                      ...
                      >
                        ...
                        <stop offset="1" stopColor="#E12653"></stop>
                      </linearGradient>
                    </defs>
                  </svg>
                  <b className="text-black text-3 font-300">Google Play</b>
                </div>
              </div>
              <span className="text-[14px] block text-black my-5.5 font-semibold">
